         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="header-search-2" style=" border-radius: 0; padding-right: 15px;padding-top: 0;position: fixed;top: 0;z-index: 9999;width: -webkit-fill-available;">
                        ...
                        <div class="col-md-10 col-xs-9" style="padding-left:0;">
                           <div class="header-search-2" style="text-align: center;">
                              <form id="form" action="/marketplace/product/search" method="POST">
                                 <input class="input" name="nama_produk" placeholder="Search here"
                                    style="width: calc(100% - 46px); padding:0 30px">
                                 <button type='submit' class="search-btn" style="background-color: #FFF; color: inherit;">
                                    <i class="fa-solid fa-magnifying-glass" style="padding: 0 10px;"></i>
                                 </button>
                              </form>
                           </div>
