      ...
      <div class="col-12">
         <div class="card">
            <div class="card-header">
               <h4>Input Data Paket Usaha</h4>
            </div>
            <form action="<?php echo base_url('/admin/simpan-paket');?>" method="post" class="form"
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="form-group mandatory">
                              ...
                              <input type="text" class="form-control" id="nama_paket" name="nama_paket"
                                 placeholder="Masukkan Nama Paket Usaha" data-parsley-required="true">
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="form-floating">
                                 <textarea class="form-control" placeholder="Detail Paket Usaha" id="floatingTextarea"
                                    data-parsley-required="true" style="height: 115px;" name="keterangan"></textarea>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="date" class="form-control mb-3 flatpickr-no-config" id="tgl_tersedia"
                                    placeholder="Pilih Tanggal" name="tgl_tersedia" data-parsley-required="true">
                              </div>
                              <div class="form-group col-md-6">
                                 <label for="tgl_berakhir">Berakhir</label>
                                 <input type="date" class="form-control mb-3 flatpickr-no-config" id="tgl_berakhir"
                                    placeholder="Pilih Tanggal" name="tgl_berakhir" data-parsley-required="true">
                              </div>
                           </div>
                           <div class="divider divider-left">
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" id="kuota" min="0"
                                 placeholder="masukkan jumlah kouta" name="kuota" data-parsley-required="true">
                           </div>
                           <div class="form-group">
