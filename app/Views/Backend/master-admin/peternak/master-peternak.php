         ...
         <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Peternak</li>
               </ol>
            </nav>
         </div>
      </div>
               ...
               <table class="table" id="table1">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="/admin/edit-peternak/<?php echo $data['id_user']?>" class="btn btn-sm btn-warning">
                              <i class="bi bi-pencil-square"></i>
                           </a>
                           <a href="/admin/detail-peternak/<?php echo $data['id_user']?>" class="btn btn-sm btn-info ">
