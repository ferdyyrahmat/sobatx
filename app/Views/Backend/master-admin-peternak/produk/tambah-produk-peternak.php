         ...
         <div class="row">
            <div class="card">
               ...
               <div class="col-md-12 product-details">
                  <form action="<?= base_url()?>admin/simpan-produk" method="post" enctype="multipart/form-data">
                     <div class="card-body">
                        <div class="row">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" name="harga" class="form-control" id="dengan-rupiah"
                                       aria-label="Harga" style="text-align: right;" min="0"
                                       aria-describedby="basic-addon1" placeholder="0" required>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="number" class="form-control" name="stok" value="0" min="0" max="999"
                                    required>
                              </div>
                           </div>
                        </div>
