            ...
            <div id="auth-left" style="padding: 2rem;">
               <div class="auth-logo" style="text-align: center; margin-bottom: 2rem;">
                  <a href="index.html"><img
                        src="<?= base_url()?>Assets/Backend/admin/assets/compiled/png/logo-sobatx.png" alt="Logo"
                        style="width: 50%; height: auto;"></a>
               </div>
               <h1 class="auth-title" style="font-size: 3rem;">Log in.</h1>
               <p>Log in with your data that you entered during registration.</p>

               <form action="<?= base_url('admin/cek-login-admin'); ?>" method="post">
                  <div class="form-group position-relative has-icon-left mb-4">
                     <input name="email" type="text" class="form-control form-control-xl" placeholder="E-mail">
